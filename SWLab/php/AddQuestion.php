    ...
    if ($errores == ''){
      ...
      $vacio=null;
            ...
            $link = mysqli_connect ($server, $user, $pass, $basededatos);
              ...
              (ID,email,ePregunta,respuestaC,respuesta2,respuesta3,respuesta4,complejidad,tema,foto) VALUES ('0','$email','$ePregunta','$respuestaC','$respuesta2','$respuesta3','$respuesta4','$complejidad','$tema','$vacio')";
              ...
              if (!mysqli_query($link, $sql))
              {
                ...
                mysqli_close($link);
                echo "<span style='color:blue'>Pregunta almacenada en la BD</span>";
